...
if __name__ == "__main__":
    from eventcalendar_main import validate_input, next_date, previous_date
    from eventcalendar_dotw import get_doomsday_dotw, get_dotw
    from eventcalendar_events import read_events, sort_events, sort_events_fast, get_events_binary_search
    ...
    assert get_events_binary_search((11, 2, 2021)) == ["Dia de los Muertos",
                                                       "All Soul's Day"] or get_events_binary_search((11, 2, 2021)) == [
